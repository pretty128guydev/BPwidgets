...
const actionRemoveInstrumentFromFavorites = (instrumentID: number) =>
  action(REMOVE_INSTRUMENT_FROM_FAVS, instrumentID)
const actionAddInstrumentToFavorites = (instrumentID: number) =>
...
const actionRemoveInstrumentFromTop = (instrumentID: number) =>
  action(REMOVE_INSTRUMENT_FROM_TOP, instrumentID)
const actionAddInstrumentToTop = (instrumentID: number) =>
