    ...
    try {
      ...
      this.setState({ contents: data }, () => {
        ...
        if (node) {
          ...
          const forthPath = paths[3]
          if (this.props.fill) {
            child.setAttribute('fill', this.props.fill)
            if (firstPath) firstPath.setAttribute('fill', this.props.fill)
            if (secondPath) secondPath.setAttribute('fill', this.props.fill)
            if (thirdPath) thirdPath.setAttribute('fill', this.props.fill)
            if (forthPath) forthPath.setAttribute('fill', this.props.fill)
          }
          if (this.props.stroke) {
            child.setAttribute('stroke', this.props.stroke)
            if (firstPath) firstPath.setAttribute('stroke', this.props.stroke)
            if (secondPath) secondPath.setAttribute('stroke', this.props.stroke)
            if (thirdPath) thirdPath.setAttribute('stroke', this.props.stroke)
            if (forthPath) forthPath.setAttribute('stroke', this.props.stroke)
          }
          if (this.props.width) {
