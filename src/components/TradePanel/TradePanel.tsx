...
import { lastQuoteRiskForSelectedInstrument } from '../../components/selectors/instruments'
...
const TradePanel = (props: ITradePanelProps) => {
  ...
  const { wallets, activeWallet } = props.wallets
  ...
  return (
    <>
      <BottomPositionPanel colors={props.colors}>
              ...
              <TradeTable colors={props.colors}>
                <thead>
                  <tr>
                    ...
                    <th>{t`Direction`}</th>
                    <th>{t`Symbol`}</th>
                    <th>{props.checkedLots ? t`Lots` : t`Units`}</th>
                    <th>{t`Amount`}</th>
                    <th>
                      {props.bottomTab === 'open' ||
                      props.bottomTab === 'closed'
                    ...
                    {props.bottomTab === 'open' && <th>{t`Swap`}</th>}
                    ...
                    {props.bottomTab === 'closed' &&
                      props.commissionEnabled && <th>{t`Commission`}</th>}
                  </tr>
                </thead>
                <tbody>
                  {props.trades[props.bottomTab]?.map(
                    (item: any, index: any) => {
                      if (
                        !item.walletID ||
                        item.walletID !== activeWallet.walletID
                      )
                        return <></>
                            ...
                            <td className="fit-content">
                              <Button
                                ...
                                style={{
                                  ...
                                  borderColor: props.colors.backgroundHue3,
                                  backgroundColor: props.colors.backgroundHue3,
        ...
        {tradeStopLossEditing && activeWallet.isMargin && (
          <ModalEditStopLoss
        ...
        {tradeTakeProfitEditing && activeWallet.isMargin && (
          <ModalEditTakeProfit
