...
import ChallengeIcon from '../../SideMenuBar/icons/challengeIcon'
...
import Challenge from '../../SideMenuBar/Challenge'
...
interface IDrawerMenuProps {
  colors: any
  isLoggedIn: boolean
  setShowMenuContent: (link: any) => void
      ...
      <div className="top-menu">
        {challengesEnabled && (
          <div key={'Challenge'}>
            <div
              className={`menu-item ${
                currentActiveItem === 'Challenge' ? 'item-active' : ''
              }`}
              onClick={() =>
                setShowMenuContent(<Challenge onClose={onClose} />)
              }
            >
              <span className="fill-color">
                <span>
                  {getIcon('Challenge', currentActiveItem === 'Challenge')}
                </span>
...
const mapStateToProps = (state: any) => ({
  ...
  challengesEnabled: state.registry.data.partnerConfig.challengesEnabled,
})
