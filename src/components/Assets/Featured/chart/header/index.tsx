...
import InstrumentPrice from '../../../../ChartContainer/Instruments/InstrumentPrice'
  ...
  return (
    <HeaderContainer colors={colors}>
      ...
      <TitleContainer>
        ...
        />
        <AssetNameCaption colors={colors}>{instrumentName}</AssetNameCaption>
      </TitleContainer>
      <SubTitleContainer>
        <AssetPriceCation colors={colors}>
          {closed && <span>...</span>}
          {!closed && <InstrumentPrice fixed={2} instrumentId={instrumentID} />}
        </AssetPriceCation>
